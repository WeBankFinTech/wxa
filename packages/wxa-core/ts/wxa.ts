...
interface WxaComponentClass extends Partial<WechatMiniprogram.Component.Lifetimes> {
    ...
    methods?: Record<string, ((...args: any[]) => any) | any>;
    properties?: Record<string, WechatMiniprogram.Component.AllProperty>;
    $go?: (...args: any[]) => void;
    $diff?: (data: WechatMiniprogram.Component.Data<any>) => void;
    [propName: string]: WechatMiniprogram.IAnyObject;
}

type WxaComponent = WxaComponentClass | (WechatMiniprogram.Component.Options<Record<string, any>, Record<string, WechatMiniprogram.Component.AllProperty>, Record<string, (...args: any[]) => any>, WechatMiniprogram.IAnyObject, boolean> & Record<string, WechatMiniprogram.IAnyObject>);
...
export class Wxa {
    ...
    public launchApp(instance: WxaComponent) {
        let vm = instance;
    ...
    public launchPage(instance: WxaComponent, pagePath: string) {
        let vm = instance;
