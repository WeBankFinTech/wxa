...
it('checks if a date is between two other dates - left inclusive', () => {
  const format = 'DD/MM/YYYY';
...
it('checks if a date is between two other dates - right inclusive', () => {
  const format = 'DD/MM/YYYY';
...
it('checks if a date is between two other dates - all inclusive', () => {
  const format = 'DD/MM/YYYY';
