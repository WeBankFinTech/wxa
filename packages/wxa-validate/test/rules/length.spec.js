...
it('null and undefined are always rejected', () => {
  expect(validate(null, [3])).toBe(false);
  expect(validate(undefined, [3])).toBe(false);
});

it('validates number of elements in an enumerable', () => {
...
it('validates number of elements in an array', () => {
  // exact length
...
it('validates strings consisting of numbers', () => {
